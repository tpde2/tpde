...
; ARM64-NEXT:    b.ne 0xc <atomicrmw_fmax_float_seq_cst+0xc>
...
; ARM64-NEXT:    fmov s1, w3
; ARM64-NEXT:    cmp w3, w1
; ARM64-NEXT:    b.ne 0x4c <atomicrmw_fmax_float_seq_cst_nouse+0xc>
; ARM64-NEXT:    fmov s0, s1
; ARM64-NEXT:    ldp x29, x30, [sp], #0xa0
; ARM64-NEXT:    ret
  %r = atomicrmw fmax ptr %p, float %a seq_cst
...
; ARM64-NEXT:    b.ne 0x8c <atomicrmw_fmax_double_seq_cst+0xc>
...
; ARM64-NEXT:    fmov d1, x3
; ARM64-NEXT:    cmp x3, x1
; ARM64-NEXT:    b.ne 0xcc <atomicrmw_fmax_double_seq_cst_nouse+0xc>
; ARM64-NEXT:    fmov d0, d1
; ARM64-NEXT:    ldp x29, x30, [sp], #0xa0
; ARM64-NEXT:    ret
  %r = atomicrmw fmax ptr %p, double %a seq_cst
