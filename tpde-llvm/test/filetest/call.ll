...
; ARM64-NEXT:    bl 0x1cc <call_i32_i128_i128_i32_i128_i32+0x3c>
; ARM64-NEXT:     R_AARCH64_CALL26 fn_i32_i128_i128_i128_i32
...
; ARM64-NEXT:    bl 0x21c <call_i128_i128_i128_i32_i128+0x3c>
...
; ARM64-NEXT:    bl 0x278 <call_i128_i128_i128_i128_i32_i128+0x48>
...
; ARM64-NEXT:    bl 0x300 <call_i128_i128_i32_tmp+0x30>
...
; ARM64-NEXT:    bl 0x350 <call_i128_i128_i128_i32_tmp+0x40>
...
; ARM64-NEXT:    bl 0x3ec <call_i32_vararg+0xc>
...
; ARM64-NEXT:    bl 0x49c <call_i64_i64_i64_i64_i64_2xi64+0x2c>
...
; ARM64-NEXT:    bl 0x4e8 <call_v_a3f64+0x18>
...
; ARM64-NEXT:    mov x0, x2
; ARM64-NEXT:    bl 0x554 <call_v_a3f64_a3f64+0x24>
...
; ARM64-NEXT:    str d8, [sp, #0x10]
; ARM64-NEXT:    bl 0x604 <call_v_a3f64_a3f64_a3f64+0x44>
...
; ARM64-NEXT:    ldr x7, [x29, #0xb8]
; ARM64-NEXT:    str x7, [sp, #0x8]
; ARM64-NEXT:    bl 0x660 <call_i64_i64_i64_i64_i64_i64_i64_2xi64+0x40>
...
; ARM64-NEXT:    bl 0x72c <call_sret+0xc>
...
; ARM64-NEXT:    bl 0x790 <call_sret_manyargs+0x50>
; ARM64-NEXT:     R_AARCH64_CALL26 call_sret_tgt
; ARM64-NEXT:    add sp, sp, #0x20
; ARM64-NEXT:    ldp x29, x30, [sp], #0xc0
; ARM64-NEXT:    ret
...
; ARM64-NEXT:    bl 0x7cc <alloca_call+0x2c>
...
; ARM64-NEXT:    bl 0x84c <call_fn_v_i8sext_i8sext_i8sext+0x1c>
...
; ARM64-NEXT:    strb w3, [x29, #0xa0]
; ARM64-NEXT:    bl 0x87c <call_fn_v_i8zext_i8zext_i8zext+0x1c>
...
; ARM64-NEXT:    bl 0x8a8 <call_fn_v_i1z_i1s_i37z_i37s+0x18>
...
; ARM64-NEXT:    str x8, [sp, #0x18]
; ARM64-NEXT:    bl 0x92c <call_fn_v_stack_i1z_i1s_i37z_i37s+0x6c>
...
; ARM64-NEXT:    mov x29, sp
; ARM64-NEXT:    mov x0, #0x1 // =1
; ARM64-NEXT:    bl 0x94c <call_fn_a2s0_s0_s1s0_i32+0xc>
...
; ARM64-NEXT:    mov x29, sp
; ARM64-NEXT:    str x0, [x29, #0xa0]
; ARM64-NEXT:    bl 0x96c <call_vararg_ind+0xc>
